return {
  ...
  config = function()
    ...
    require("diffview").setup({
      ...
      view = {
        ...
        default = {
          ...
          layout = "diff2_horizontal",   -- Default to horizontal split
      ...
      keymaps = {
        ...
        diff1 = {
          ...
          { "n", "g?", actions.help, { desc = "Open the help panel" } },
        },
        diff2 = {
    ...
    -- Main keymaps for opening diffview
    vim.keymap.set('n', '<leader>du', ':DiffviewOpen<CR>', { desc = "Diff: Open diffview (side-by-side)" })
    vim.keymap.set('n', '<leader>dv', ':DiffviewOpen --layout=diff2_vertical<CR>', { desc = "Diff: Open vertical split diff" })
    vim.keymap.set('n', '<leader>dc', ':DiffviewClose<CR>', { desc = "Diff: Close diff view" })
